...
```html
<div data-pym-src="https://static.startribune.com/news/projects/all/bluewave">Loading...</div>
...
1.  Create an LCD that is connected to the Article.
    ...
    * Common values in the LCD to use:
      ...
      * `styles`: `news/projects/all/bluewave/styles.bundle.css`
      * `scripts`: `news/projects/all/bluewave/app.bundle.js`
...
```js
{
  "publish": {
    "default": {
      ...
      "path": "news/projects-staging/all/bluewave/",
      "url": "http://static.startribune.com/news/projects-staging/all/bluewave/"
    },
    "production": {
      "bucket": "static.startribune.com",
      "path": "news/projects/all/bluewave/",
      "url": "http://static.startribune.com/news/projects/all/bluewave/"
    }
  }
}
```
